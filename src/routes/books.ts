  ...
  .post(
    ...
    },
    {
      body: t.Object({
        ...
        status: t.Union([t.Literal("reading"), t.Literal("finished"), t.Literal("want_to_read")]),
      }),
    }
  )
  .patch(
    ...
    },
    {
      body: t.Object({
        ...
        status: t.Optional(t.Union([t.Literal("reading"), t.Literal("finished"), t.Literal("want_to_read")])),
      }),
    }
  )
