...
export interface ParsedIntent {
  ...
  fields?: {
    ...
    author?: string;
    cover_url?: string;
    status?: "reading" | "finished" | "want_to_read" | "on_hold" | "dropped";
    rating?: number;
    note?: string;
    note_page?: number;
  };
...
- update_status: user marks book as reading/finished/want_to_read/on_hold/dropped
...
Return ONLY valid JSON matching this schema:
{
  ...
  "fields": {
    ...
    "status": "<reading|finished|want_to_read|on_hold|dropped or null>",
    "rating": <1-5 or null>,
    "note": "<string or null>",
...
- "drop Negeri 5 Menara" → update_status, dropped
- "gak jadi baca Negeri 5 Menara" → update_status, dropped`;
